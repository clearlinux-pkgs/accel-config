...
Version  : 3.5.3
Release  : 2
URL      : https://github.com/intel/idxd-config/archive/accel-config-v3.5.3/idxd-config-3.5.3.tar.gz
Source0  : https://github.com/intel/idxd-config/archive/accel-config-v3.5.3/idxd-config-3.5.3.tar.gz
...
%prep
%setup -q -n idxd-config-accel-config-v3.5.3
cd %{_builddir}/idxd-config-accel-config-v3.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677273513
