...
Version  : 4.1.6
Release  : 11
URL      : https://github.com/intel/idxd-config/archive/accel-config-v4.1.6/idxd-config-4.1.6.tar.gz
Source0  : https://github.com/intel/idxd-config/archive/accel-config-v4.1.6/idxd-config-4.1.6.tar.gz
...
%prep
%setup -q -n idxd-config-accel-config-v4.1.6
cd %{_builddir}/idxd-config-accel-config-v4.1.6
pushd ..
cp -a idxd-config-accel-config-v4.1.6 buildavx2
popd
pushd ..
cp -a idxd-config-accel-config-v4.1.6 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709285183
