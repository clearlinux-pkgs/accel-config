...
Version  : 4.1.7
Release  : 12
URL      : https://github.com/intel/idxd-config/archive/accel-config-v4.1.7/idxd-config-4.1.7.tar.gz
Source0  : https://github.com/intel/idxd-config/archive/accel-config-v4.1.7/idxd-config-4.1.7.tar.gz
...
%prep
%setup -q -n idxd-config-accel-config-v4.1.7
cd %{_builddir}/idxd-config-accel-config-v4.1.7
pushd ..
cp -a idxd-config-accel-config-v4.1.7 buildavx2
popd
pushd ..
cp -a idxd-config-accel-config-v4.1.7 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718382041
