...
Source0  : https://github.com/intel/idxd-config/archive/accel-config-v4.1.4/idxd-config-4.1.4.tar.gz
...
%prep
%setup -q -n idxd-config-accel-config-v4.1.4
cd %{_builddir}/idxd-config-accel-config-v4.1.4
pushd ..
cp -a idxd-config-accel-config-v4.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702269309
