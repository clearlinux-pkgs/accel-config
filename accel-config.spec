...
Version  : 4.1.5
Release  : 10
URL      : https://github.com/intel/idxd-config/archive/accel-config-v4.1.5/idxd-config-4.1.5.tar.gz
Source0  : https://github.com/intel/idxd-config/archive/accel-config-v4.1.5/idxd-config-4.1.5.tar.gz
...
%prep
%setup -q -n idxd-config-accel-config-v4.1.5
cd %{_builddir}/idxd-config-accel-config-v4.1.5
pushd ..
cp -a idxd-config-accel-config-v4.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706280547
